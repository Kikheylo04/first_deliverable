...
INSERT INTO categorie (name) VALUES ('Design UI/UX') , ('DevOps');

INSERT INTO course ( title  ,  description  , level, teacher , categorie  ) VALUES ('Figma' , 'Herramienta de prototipado web' , 1 , 1 , 1) , ('AWS' , 'Plataforma integral de computación' , 3, 1 , 2);

INSERT INTO item_course (course, student) VALUES (2,1), (1, 1);
INSERT INTO course_video (title , url , course) VALUES ('Aprendiendo Frame' , 'https://figma.com/frame' , 1) , ('S3' , 'https://aws/s3' , 2);
